  ...
  <div class="container-fluid p-0 row g-0">
    <div class="col-md-2 d-inline vh-auto">
      ...
      <div class="col-md-10 user vh-100">
        ...
        <button onclick="window.location.href='users/form'" class="btn btn-success my-2" style="margin-left: 12.5%"><i class="fas fa-plus"></i> Add</button>
        ...
        <table class="table text-center w-75 rounded table-striped table-bordered table-hover">
          ...
          <c:forEach items="${listUser}" var="user">
            <tr class="align-middle">
              ...
              <th>
                <button onclick="window.location.href='users/form?id=${user.id}&action=update'" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</button>
                <button onclick="del(${user.id})" class="btn btn-danger"><i class="fas fa-trash-can"></i> Remove</button>
              </th>
            </tr>
          </c:forEach>
        </table>
