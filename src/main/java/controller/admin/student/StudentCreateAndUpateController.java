...
public class StudentCreateAndUpateController extends HttpServlet {
  ...
  private void setAll(Student s, String address, LocalDate birthday, int classId, String email, String name,
      String phone, String sex, String status) {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    if ("update".equals(action)) {
      ...
      setAll(s, address, LocalDate.parse(birthday), Integer.parseInt(classId), email, name, phone, sex, status);
      student.update(s);
    } else {
      Student s = new Student();
      setAll(s, address, LocalDate.parse(birthday), Integer.parseInt(classId), email, name, phone, sex, status);
