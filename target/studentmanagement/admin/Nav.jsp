...
<div class="container-fluid p-0">
  <div class="bg-dark text-light vh-100 d-flex flex-column">
    <div class="text-center pt-4 mb-5" >
      ...
      <a href="${pageContext.request.contextPath}/change" class="d-block text-light text-decoration-none p-2 bg-secondary anav">Change password</a>
    </div>
    <h5 >Menu Admin</h5>
    <ul class="nav d-flex flex-column">
      ...
      <c:if test="${sessionScope.user.role eq 'master'}">
        <li class="nav-item">
          <a class="nav-link text-center text-white bg-secondary anav" href="/admin/subject">Browse</a>
        </li>
      </c:if>
    </ul>
